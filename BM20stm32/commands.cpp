...
/*
  ...
  Bit 0 EQ mode
  Bit 1 remote device friendly name
  Bit 2 AVC specific response
...
*/
uint8_t  IS2020::Change_Device_Name() {
  IS2020::getNextEventFromBT();
...
uint8_t  IS2020::AVC_Specific_Cmd() {
  IS2020::getNextEventFromBT();
  IS2020::DBG("AVC_Specific_Cmd\n");
  ...
  return checkResponce(EVT_Command_ACK);
//  if (checkResponce(EVT_Command_ACK))
//    return checkResponce(EVT_AVC_Specific_Rsp);
//  return false;
}
/*

*/
uint8_t  IS2020::AVC_Group_Navigation() {
  IS2020::getNextEventFromBT();
  IS2020::DBG("AVC_Group_Navigation\n");
  return checkResponce(EVT_Command_ACK);
}
...
uint8_t  IS2020::Read_Local_Device_Name() {
  IS2020::getNextEventFromBT();
  IS2020::DBG("Read_Local_Device_Name\n");
...
String IS2020::decodeCommand(uint8_t cmd){
    switch(cmd){
      case 0x00:
        return("Make Call");
      break;
      case 0x01:
        return("Make Extension Call");
      break;
      case 0x02:
        return("MMI Action");
      break;
      case 0x03:
        return("Event Mask Setting");
      break;
      case 0x04:
      ...
      break;
      case 0x07:
        return("BTM_Parameter_Setting");
      break;
      case 0x08:
        return("Read_BTM_Version");
      break;
      case 0x09:
        return("Get PB By AT Cmd");
      break;
      case 0x0A:
        return("Vendor AT Command");
      break;
      case 0x0B:
        return("AVC Specific Cmd");
      break;
      case 0x0C:
        return("AVC Group Navigation");
      break;
      case 0x0D:
        return("Read Link Status");
      break;
      case 0x0E:
        return("Read Paired Device Record");
      break;
      case 0x0F:
        return("Read Local BD Address");
      break;
      case 0x10:
        return("Read Local Device Name");
      break;
      case 0x11:
        return("Set Access PB Method");
      break;
      case 0x12:
        return("Send SPP iAP Data");
      break;
      case 0x13:
        return("BTM Utility Function");
      break;
      case 0x14:
        return("Event ACK");
      break;
      case 0x15:
        return("Additional Profiles Link Setup");
      break;
      case 0x16:
        return("Read Linked Device Information");
      break;
      case 0x17:
        return("Profiles Link Back");
      break;
      case 0x18:
        return("Disconnect");
      break;
      case 0x19:
        return("MCU Status Indication");
      break;
      case 0x1A:
        return("User Confirm SPP Req Reply");
      break;
      case 0x1B:
        return("Set HF Gain Level");
      break;
      case 0x1C:
        return("EQ Mode Setting");
      break;
      case 0x1D:
        return ("DSP NR CTRL");
      break;
      ...
      break;
      case 0x1F:
        return ("MCU UART Rx Buffer Size");
      break;
      case 0x20:
        return ("Voice Prompt Cmd");
      break;
      case 0x21:
        return ("MAP REQUEST");
      break;
      case 0x22:
        return ("Security Bonding Req");
      break;
      case 0x23:
        return ("Set Overall Gain");
      break;
      default:
