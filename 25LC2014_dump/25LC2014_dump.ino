//code for dumping eeprom from acceledent aura when it stops working and the LED Indicator is flashing alternating green and orange 
...
void setup()
{
  ...
  for (long i = 0; i <= 131072; i++) {
    ...
    Serial.write(value);                    // Let's see what we got
    //Serial.print(" ");
    /*y++;
      if(y==32){
      Serial.println();
